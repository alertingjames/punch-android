...
import com.unitedwebspace.punchcard.main.NotificationsActivity;
...
public class NotificationListAdapter2 extends BaseAdapter {
    ...
    public NotificationListAdapter2(NotificationsActivity context){
        super();
