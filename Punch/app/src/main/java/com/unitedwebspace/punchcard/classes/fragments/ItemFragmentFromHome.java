package com.unitedwebspace.punchcard.classes.fragments;
...
public class ItemFragmentFromHome extends Fragment {
    ...
    public static Fragment newInstance(CardsFragment context, int pos, Plan plan, float scale) {
        Bundle b = new Bundle();
        ...
        return Fragment.instantiate(context.getContext(), ItemFragmentFromHome.class.getName(), b);
    }
