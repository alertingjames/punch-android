...
public class FontListForEditCardAdapter extends BaseAdapter{

    private Font data = new Font();
    private LayoutInflater mInflater;
    private EditCardActivity context;

    public FontListForEditCardAdapter(EditCardActivity context, Font font) {
