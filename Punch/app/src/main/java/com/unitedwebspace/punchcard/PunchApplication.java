...
import com.unitedwebspace.punchcard.utils.FileUtils;
import com.unitedwebspace.punchcard.utils.LruBitmapCache;
...
public class PunchApplication extends Application {
    public static final String TAG = PunchApplication.class.getSimpleName();
    ...
    private static PunchApplication _instance;
    ...
    public static synchronized PunchApplication getInstance(){
